    ...
    render() {
        return (
            <View style={styles.container}>
                <TouchableOpacity style={[styles.button, {backgroundColor: '#16a085'}]} />
                <TouchableOpacity style={[styles.button, {backgroundColor: '#34495e'}]} />
                <TouchableOpacity style={[styles.button, {backgroundColor: '#2980b9'}]} />
                <TouchableOpacity style={[styles.button, {backgroundColor: '#f1c40f'}]} />
                <TouchableOpacity style={[styles.button, {backgroundColor: '#c0392b'}]}/>
                <TouchableOpacity style={[styles.button, {backgroundColor: '#6c5ce7'}]}/>
                <TouchableOpacity style={[styles.button, {backgroundColor: '#fd79a8'}]}/>
